...
public class AddFriendGUICallback extends AbstractGUICallback {
    ...
    public void init() {        
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(ClientReference.localize("oxygen.gui.friends.addFriendCallback"), true, GUISettings.instance().getTitleScale()));   
        this.addElement(new GUITextLabel(2, 16).setDisplayText(ClientReference.localize("oxygen.gui.friends.addFriendCallback.request"), false, GUISettings.instance().getTextScale()));  
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element, int mouseButton) {
        if (element == this.cancelButton)
            ...
            if (this.players.containsKey(this.usernameField.getTypedText())) 
                FriendsListManagerClient.instance().sendFriendRequestSynced(this.players.get(this.usernameField.getTypedText()));
