package austeretony.oxygen_friendslist.client.gui.friendslist.friendlist;
...
public class FriendListBackgroundGUIFiller extends BackgroundGUIFiller {
    ...
    public FriendListBackgroundGUIFiller(int xPosition, int yPosition, int width, int height) {             
        ...
        this.textureExist = ClientReference.isTextureExist(FriendsListGUIScreen.FRIEND_LIST_BACKGROUND_TEXTURE);
    }
    ...
    public void draw(int mouseX, int mouseY) {  
        ...
        if (this.textureExist) {  
            ...
            this.mc.getTextureManager().bindTexture(FriendsListGUIScreen.FRIEND_LIST_BACKGROUND_TEXTURE);                         
