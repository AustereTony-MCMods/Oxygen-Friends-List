...
public class RemoveFriendCallbackGUIFiller extends BackgroundGUIFiller {

    public RemoveFriendCallbackGUIFiller(int xPosition, int yPosition, int width, int height) {             
        super(xPosition, yPosition, width, height, FriendsListGUIScreen.REMOVE_FRIEND_CALLBACK_BACKGROUND);
    }
