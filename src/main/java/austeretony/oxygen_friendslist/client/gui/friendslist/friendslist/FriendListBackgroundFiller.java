...
public class FriendListBackgroundFiller extends OxygenBackgroundFiller {

    public FriendListBackgroundFiller(int xPosition, int yPosition, int width, int height) {             
