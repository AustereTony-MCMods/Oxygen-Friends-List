...
public class AddFriendCallbackGUIFiller extends BackgroundGUIFiller {

    public AddFriendCallbackGUIFiller(int xPosition, int yPosition, int width, int height) {             
        super(xPosition, yPosition, width, height, FriendsListGUIScreen.ADD_FRIEND_CALLBACK_BACKGROUND);
    }
