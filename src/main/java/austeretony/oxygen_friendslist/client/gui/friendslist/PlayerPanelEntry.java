...
public class PlayerPanelEntry extends OxygenIndexedPanelEntry<UUID> {
    ...
    public PlayerPanelEntry(ListEntry entry) {
    ...
    public void drawTooltip(int mouseX, int mouseY) {
        ...
        if (this.hasNote && mouseX >= this.getX() + this.getWidth() - 20 && mouseY >= this.getY() + 2 && mouseX < this.getX() + this.getWidth() - 12 && mouseY < this.getY() + 8)
            this.drawTooltip(mouseX - this.textWidth(this.note, this.getTooltipScaleFactor()), mouseY, this.note);
